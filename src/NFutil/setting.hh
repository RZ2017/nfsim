...
//#define DEBUG_ACTIVE    		0x0FFF  //activate everything
//#define DEBUG_ACTIVE 0//(READ_FILE|CHECK_LBG) //SHOW_FIRE//(READ_FILE|SHOW_SIM)//0xFFFF //(READ_FILE |CREATE_REACTION | CREATE_FUNC | CREATE_OBS)  //(READ_FILE | CREATE_FUNC | CREATE_OBS)
//#define DEBUG_ACTIVE CREATE_TEMPLATES | CREATE_MOLECULE | CREATE_TEMPLATES | CREATE_REACTION //SHOW_FIRE//(READ_FILE|SHOW_SIM)//0xFFFF //(READ_FILE |CREATE_REACTION | CREATE_FUNC | CREATE_OBS)  //(READ_FILE | CREATE_FUNC | CREATE_OBS)
#define DEBUG_ACTIVE 			(SHOW_FIRE | SHOW_RHS | SHOW_SIM) //| CREATE_REACTION| CREATE_FUNC
...
#define RHS_FUNC   	//Razi: Activates function evaluation in the output
   	   	   	   	    //Razi: Also check the products and avoid firing a reaction whose products are connected
						// The products should be disjoint complexes
